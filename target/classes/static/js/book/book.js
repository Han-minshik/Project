...
const closeBtn = document.querySelector('.bookViewer-close');
const bookViewer = document.querySelector('.viewer');
closeBtn.onclick = () => {
    bookViewer.style.display = 'none';
}

const viewerBtn = document.querySelector('.viewer-watch-button');
viewerBtn.onclick = () => {
